...
3 brief bullets for what the GM can do right now to keep the scene moving. The last bullet should cover a potential dice roll the players may need to make for a decision, including a suggested target number (that says suggested target number) for success and a possible outcome if the roll fails.
